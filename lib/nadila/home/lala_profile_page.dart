...
import '../widget/lala_profile.dart';

class LalaProfilePage extends StatelessWidget {
  const LalaProfilePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final profile = LalaProfileData.defaultProfile;
    return Scaffold(
